 ...
 * @brief Callback classes, these are similar to closures but can take
 * arguments at execution time.
 *
 * @note These classes are autogenerated by gen_callbacks.py. Please run edit
 * & run gen_callbacks.py if you need to add more types.
 *
 * @details Callbacks are similar to function pointers, they allow both
 * functions and methods to be invoked at a later time with data from either
 * / both the time the Callback is constructed and the time the Callback is
 * executed. All Callbacks have a Run() method, which is how the Callback is
 * executed. Callbacks come on two varieties, Persistent and SingleUse.
 * SingleUse callbacks delete themselves after Run() is called so you don't
 * have to.
 *
 * @snippet
 *   @code
 ...
 *   BaseCallback1<void, unsigned int> *callback3 = NewCallback(object,
 *   &Object::Method1);
 *
...
/**
 * @brief A callback, this can be called multiple times
 */
template <typename ReturnType>
...
/**
 * @brief A single use callback, this deletes itself after it's run.
 */
template <typename ReturnType>
...
/**
 * @brief A single use callback returning void.
 */
template <>
...
/**
 * @brief Helper method to create a new SingleUseCallback.
 */
template <typename ReturnType>
...
/**
 * @brief Helper method to create a new Callback.
 */
template <typename ReturnType>
