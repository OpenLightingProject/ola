...
typedef enum {
  ...
  // E1.37-5 PIDs
  // Product Information
  PID_MANUFACTURER_URL = 0x00D0,
  PID_PRODUCT_URL = 0x00D1,
  PID_FIRMWARE_URL = 0x00D2,
  PID_SERIAL_NUMBER = 0x00D3,
  PID_DEVICE_INFO_OFFSTAGE = 0x00D4,

  // Network Management
  PID_TEST_DATA = 0x0016,
  PID_COMMS_STATUS_NSC = 0x0017,

  // Control
  PID_IDENTIFY_TIMEOUT = 0x1050,
  PID_POWER_OFF_READY = 0x1051,

  // Configuration
  PID_SHIPPING_LOCK = 0x0650,
  PID_LIST_TAGS = 0x0651,
  PID_ADD_TAG = 0x0652,
  PID_REMOVE_TAG = 0x0653,
  PID_CHECK_TAG = 0x0654,
  PID_CLEAR_TAGS = 0x0655,
  PID_DEVICE_UNIT_NUMBER = 0x0656,

  // DMX512 Setup
  PID_DMX_PERSONALITY_ID = 0x00E2,

  // Sensor
  PID_SENSOR_TYPE_CUSTOM = 0x0210,
  PID_SENSOR_UNIT_CUSTOM = 0x0211,

  // RDM Information
  PID_METADATA_PARAMETER_VERSION = 0x0052,
  PID_METADATA_JSON = 0x0053,
  PID_METADATA_JSON_URL = 0x0054,
