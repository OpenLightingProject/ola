...
class BaseTimeVal {
 public:
  ...
  long MicroSeconds() const { return static_cast<long>(m_tv.tv_usec); }
...
class TimeInterval {
 public:
  ...
  long MicroSeconds() const { return m_interval.MicroSeconds(); }
...
class TimeStamp {
 public:
    ...
    long MicroSeconds() const { return m_tv.MicroSeconds(); }
