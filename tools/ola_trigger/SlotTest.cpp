...
void SlotTest::testIntersectingIntervalAddition() {
  Slot slot(0);
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(10, 20), NULL, NULL));

  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(10, 20), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(8, 10), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(10, 10), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(10, 11), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(10, 25), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(15, 25), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(19, 20), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(20, 20), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(20, 25), NULL, NULL));

  // now add another interval
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(30, 35), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(29, 30), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(30, 30), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(30, 35), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(34, 35), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(34, 36), NULL, NULL));

  // and another one
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(40, 45), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(29, 30), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(30, 30), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(30, 35), NULL, NULL));
  CPPUNIT_ASSERT(!slot.AddAction(ValueInterval(34, 35), NULL, NULL));
...
void SlotTest::testIntervalAddition() {
  Slot slot(0);
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(10, 20), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(string("[10, 20]"), slot.IntervalsAsString());

  // add before the begining
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(5, 6), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(string("[5, 6], [10, 20]"),
                       slot.IntervalsAsString());

  // add at the end
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(100, 104), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(string("[5, 6], [10, 20], [100, 104]"),
                       slot.IntervalsAsString());

  // now try adding some in the middle
  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(80, 82), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(string("[5, 6], [10, 20], [80, 82], [100, 104]"),
                       slot.IntervalsAsString());

  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(76, 76), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(string("[5, 6], [10, 20], 76, [80, 82], [100, 104]"),
                       slot.IntervalsAsString());

  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(70, 72), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(
      string("[5, 6], [10, 20], [70, 72], 76, [80, 82], [100, 104]"),
      slot.IntervalsAsString());

  CPPUNIT_ASSERT(slot.AddAction(ValueInterval(65, 69), NULL, NULL));
  CPPUNIT_ASSERT_EQUAL(
...
void SlotTest::testActionMatching() {
  ...
  CPPUNIT_ASSERT(!slot.SetDefaultRisingAction(default_rising_action));
