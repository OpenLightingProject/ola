...
class LlaConfigurator {
  public:
     ...
     */
    LlaConfigurator(int device_id, lla_plugin_id plugin_id):
    ...
    void HandleDevices(const vector <lla::LlaDevice> devices, const string &error);
    bool SendMessage(google::protobuf::Message &message);

    // Subclasses implement this
    virtual void HandleConfigResponse(const string &reply, const string &error) = 0;
