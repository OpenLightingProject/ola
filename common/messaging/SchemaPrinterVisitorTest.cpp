 ...
 *
 * SchemaPrinterVisitorTest.cpp
 * Test fixture for the SchemaPrinterVisitor class.
...
using ola::messaging::SchemaPrinterVisitor;
...
class SchemaPrinterVisitorTest: public CppUnit::TestFixture {
  CPPUNIT_TEST_SUITE(SchemaPrinterVisitorTest);
  CPPUNIT_TEST(testPrinter);
  CPPUNIT_TEST_SUITE_END();

  public:
    SchemaPrinterVisitorTest() {}
    void testPrinter();
};


CPPUNIT_TEST_SUITE_REGISTRATION(SchemaPrinterVisitorTest);


/*
 * Test the SchemaPrinterVisitor
 */
void SchemaPrinterVisitorTest::testPrinter() {
  // setup some fields
  ...
  SchemaPrinterVisitor printer(false, false);
