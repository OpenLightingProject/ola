...
#ifndef PLUGINS_USBPRO_ROBEUSBWIDGET_H_
#define PLUGINS_USBPRO_ROBEUSBWIDGET_H_
 ...
 * A Robe USB Widget.
 */
class RobeUsbWidget: public UsbWidgetInterface {
  public:
    explicit RobeUsbWidget(ola::network::ConnectedDescriptor *descriptor);
    ~RobeUsbWidget();
...
#endif  // PLUGINS_USBPRO_ROBEUSBWIDGET_H_
