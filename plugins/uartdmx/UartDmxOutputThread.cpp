...
UartDmxOutputThread::UartDmxOutputThread(UartWidget *widget, unsigned int breakt,
                             unsigned int malft)
...
UartDmxOutputThread::~UartDmxOutputThread() {
  Stop();
}
 ...
 */
bool UartDmxOutputThread::WriteDMX(const DmxBuffer &buffer) {
 ...
 */
void UartDmxOutputThread::CheckTimeGranularity() {
  TimeStamp ts1, ts2;
  Clock clock;
