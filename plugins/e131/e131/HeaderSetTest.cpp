...
void HeaderSetTest::testDMPHeader() {
  DMPHeader header(false, false, DMPHeader::NON_RANGE, ONE_BYTES);
  ...
  DMPHeader header2(false, true, DMPHeader::RANGE_EQUAL, FOUR_BYTES);
...
void HeaderSetTest::testHeaderSet() {
  ...
  DMPHeader dmp_header(false, false, DMPHeader::NON_RANGE, ONE_BYTES);
