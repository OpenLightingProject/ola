...
TestState s15("Dual Sources with pri 20 & 10",
              ...
              "problem");
TestState s16("Dual Sources with pri 20 & 30",
              new NodeSimpleSend(20),
              new NodeSimpleSend(30),
              "512 x 30, no values of 20 otherwise this indicates a problem "
              "when a cid increases priority");
TestState s17("Dual Sources with pri 20 & 10",
              new NodeSimpleSend(20),
              new NodeSimpleSend(10, "100,100,100,100"),
              "512 x 20, may see single packet with 4 x 100");
TestState s18("Dual Sources with pri 20 & 20, HTP merge",
              new NodeSimpleSend(20, "1,1,100,100"),
              new NodeSimpleSend(20, "100,100,1,1"),
              "4 x 100 if we HTP merge for arbitration");
TestState s19("Dual Sources with pri 20 & 20, HTP merge",
              new NodeSimpleSend(20, "1,1,100,0"),
              new NodeSimpleSend(20, "100,0,1,1"),
              "[100,1,100,1] if we HTP merge for arbitration");
TestState s20("Dual Sources with one timing out",
              new NodeInactive(),
              new NodeSimpleSend(20, "100,0,1,1"),
...
TestState s22("Single Source Send",
              ...
              new NodeInactive(),
              "512 x 20");
TestState s23("Dual Sources with pri 20 & 30",
              new NodeSimpleSend(20),
              new NodeSimpleSend(30),
              "512 x 30, no values of 20 otherwise this indicates a priority "
              "problem");
...
TestState s25("Single Source Send",
              ...
              new NodeInactive(),
              "512 x 20");
TestState s26("Dual Sources with pri 20 & 20",
              new NodeSimpleSend(20),
              new NodeSimpleSend(20, "100,100,100,100"),
              "4 x 100, 508 x 20");
TestState s27("Terminate second source",
              new NodeSimpleSend(20),
              new NodeTerminate(),
              "512 x 20");
...
int main(int argv, char* argc[]) {
  ...
  StateManager manager(test_states);
  manager.Init();
  manager.Run();
}
