...
const uint16_t DMXCProjectsNodleU1Factory::VENDOR_ID_NOODLE_U1 = 0x16d0;
const uint16_t DMXCProjectsNodleU1Factory::PRODUCT_ID_NOODLE_U1 = 0x0830;

const uint16_t DMXCProjectsNodleU1Factory::VENDOR_ID_DE = 0x4b4;
const uint16_t DMXCProjectsNodleU1Factory::PRODUCT_ID_DE = 0xf1f;

const uint16_t DMXCProjectsNodleU1Factory::VENDOR_ID_FX5 = 0x16c0;
const uint16_t DMXCProjectsNodleU1Factory::PRODUCT_ID_FX5 = 0x88b;

bool DMXCProjectsNodleU1Factory::DeviceAdded(
    WidgetObserver *observer,
    libusb_device *usb_device,
    const struct libusb_device_descriptor &descriptor) {
  if (!((descriptor.idVendor == VENDOR_ID_NOODLE_U1 &&
         descriptor.idProduct == PRODUCT_ID_NOODLE_U1) ||
        (descriptor.idVendor == VENDOR_ID_DE &&
         descriptor.idProduct == PRODUCT_ID_DE) ||
