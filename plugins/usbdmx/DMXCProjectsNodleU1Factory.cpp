...
const uint16_t DMXCProjectsNodleU1Factory::VENDOR_ID_NODLE_U1 = 0x16d0;
const uint16_t DMXCProjectsNodleU1Factory::PRODUCT_ID_NODLE_U1 = 0x0830;
...
bool DMXCProjectsNodleU1Factory::DeviceAdded(
  ...
  if (!((descriptor.idVendor == VENDOR_ID_NODLE_U1 &&
         descriptor.idProduct == PRODUCT_ID_NODLE_U1) ||
