...
IGNORED_FILES = [
  ...
  'javascript/src/libs/angular/js/angular.min.js',
  'javascript/src/libs/jquery/js/jquery.min.js',
  'javascript/src/libs/bootstrap/js/bootstrap.min.js',
  'javascript/src/libs/angular-route/js/angular-route.min.js',
